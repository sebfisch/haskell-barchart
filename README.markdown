...
implementation on top of each other lets you see immideately, which
...
generate bar charts from CSV file generated by progression.
...
progressions wants the summary files to have specific names, hence, we
